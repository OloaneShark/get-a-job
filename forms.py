...
class ApplicantProfileForm(FlaskForm):
    ...
    # Globally optional. Employer-specific requirements are handled
    # by the submission adapter as Needs User Action.
